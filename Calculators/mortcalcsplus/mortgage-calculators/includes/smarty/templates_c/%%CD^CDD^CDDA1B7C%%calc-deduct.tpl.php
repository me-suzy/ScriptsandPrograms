<?php /* Smarty version 2.6.5-dev, created on 2005-05-12 11:54:30
         compiled from calc-deduct.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'calc-deduct.tpl', 77, false),)), $this); ?>
<?php $this->assign('title', "Mortgage Calculators - How much will my tax deduction be?"); ?>
<?php $this->assign('description', "Want to know how much your home loan will save you in taxes?"); ?>
...
<p id="pathway"><img src="images/bullet-path.gif" width="15" height="15" align="absMiddle">&nbsp; &nbsp;<a href="calculators.php">Mortgage calculators</a>&nbsp; /&nbsp; <b>How much will my tax deduction be?</b></p>

<?php if (! $this->_tpl_vars['savings']): ?>
<table id="texttable" align="center" cellpadding="5"><tr><td align="left">
Want to know how much your home loan will save you in taxes?<br>Fill in the boxes below to find out.
</td></tr></table><br>
<?php endif; ?>
...
<table align="center" cellpadding="5"><tr><td valign="top">
	...
	<table class="calc" cellpadding="5" cellspacing="0" align="center" width="100%">
		<tr>
			<th colspan="3"><b>How much will my tax deduction be?</b></th>
		</tr>
...
" size="3"> years
	...
	<?php if (isset($this->_foreach['savings'])) unset($this->_foreach['savings']);
$this->_foreach['savings']['total'] = count($_from = (array)$this->_tpl_vars['savings']);
$this->_foreach['savings']['show'] = $this->_foreach['savings']['total'] > 0;
if ($this->_foreach['savings']['show']):
$this->_foreach['savings']['iteration'] = 0;
    foreach ($_from as $this->_tpl_vars['saving']):
        $this->_foreach['savings']['iteration']++;
        $this->_foreach['savings']['first'] = ($this->_foreach['savings']['iteration'] == 1);
        $this->_foreach['savings']['last']  = ($this->_foreach['savings']['iteration'] == $this->_foreach['savings']['total']);
?>
		<?php if (! ( ( $this->_foreach['savings']['iteration'] - 1 ) % 2 )): ?>
		</tr>
		<tr class="<?php echo smarty_function_cycle(array('values' => 'fill01,fill02'), $this);?>
">
		<?php endif; ?>
		<td align="center"><?php echo $this->_tpl_vars['saving']['year']; ?>
</td>
		<td align="left"><?php echo $this->_tpl_vars['saving']['amount']; ?>
</td>
	<?php endforeach; unset($_from); endif; ?>
	<?php if ((1 & $this->_foreach['savings']['iteration'])): ?><td>&nbsp;</td><td>&nbsp;</td><?php endif; ?>
	</tr>
	</table>
	<?php endif; ?>
</td></tr></table>
