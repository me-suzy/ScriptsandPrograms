<?php /* Smarty version 2.6.5-dev, created on 2005-05-12 11:54:16
         compiled from calc-affordborrow.tpl */ ?>
<?php $this->assign('title', "Mortgage Calculators - How much can I borrow?"); ?>
<?php $this->assign('description', "Want to know how big of a loan you can take on?"); ?>
...
<?php if ($this->_tpl_vars['err']['income']): ?><p align="center" class="err">Gross Annual Income must be greater zero.</p><?php endif; ?>
...
<p id="pathway"><img src="images/bullet-path.gif" width="15" height="15" align="absMiddle">&nbsp; &nbsp;<a href="calculators.php">Mortgage calculators</a>&nbsp; /&nbsp; <b>How much can I borrow?</b></p>
...
<table align="center" cellpadding="5"><tr><td valign="top">
	...
	<table class="calc" cellpadding="5" cellspacing="0" align="center" width="100%">
		...
		<tr>
			<td align="right">Maximum monthly mortgage payment:</td>
			<td><b><?php echo $this->_tpl_vars['summary']['monthly_payment']; ?>
</b></td>
		</tr>
		<tr>
			<td align="right">Maximum loan amount:</td>
			<td><b><?php echo $this->_tpl_vars['summary']['loan_amount']; ?>
</b></td>
		</tr>
	</table><br>
	<?php endif; ?>
...
" size="3"> $
		...
		<tr><td align="right">
			...
			<input class="calc_input" type="text" name="param[insurance]" value="<?php echo $this->_tpl_vars['param']['insurance']; ?>
" size="3"> $
		</td><td valign="middle">
		...
		<tr><td align="right">
			...
			<input class="calc_input" type="text" name="param[income]" value="<?php echo $this->_tpl_vars['param']['income']; ?>
" size="8"> $
		</td><td valign="middle">
