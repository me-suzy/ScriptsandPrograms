...
<input type="text" name="comment" size="20" maxlength="255"><br>
<nobr>
...
<span class="say"> : </span>
<a href="Javascript:void(0);" onClick='window.open("../common/log.php", "log", "width=750, height=550, screenX=20, screenY=20, top=20, left=20, menubar=0, resizable=1, scrollbars=1, status=0, titlebar=0, toolbar=0")'>Log</a>
<span class="say"> : </span>
<a href="Javascript:void(0);" onClick='window.open("../common/smilies.php", "smilies", "width=300, height=350, screenX=20, screenY=20, top=20, left=20, menubar=0, resizable=0, scrollbars=0, status=0, titlebar=0, toolbar=0")'>=)</a>
<span class="say"> : </span>
