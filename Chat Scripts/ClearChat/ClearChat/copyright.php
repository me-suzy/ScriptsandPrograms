...
$author_name = "Petter Solås (Sensei)";
$author_email = "sensei@streamingsoundtracks.com";
$author_homepage = "http://www.streamingsoundtracks.com";
$license = "Freeware (GPL)";
$download_location = "http://www.streamingsoundtracks.com/modules.php?name=ChatInfo";
$module_version = "1.0";
$module_description = "Integrated chat block for PHP-Nuke";
