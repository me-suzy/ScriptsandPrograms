<HTML>
	<HEADER>
		<TITLE>PHP Messenger, ICQ send message sample</TITLE>
	</HEADER>
	
	<BODY><CENTER><H1>Sample using <a href="http://www.php-messenger.com">PHP Messenger</a><br>for sending ICQ messages.<br></H1>
...
<?php		
	// http://www.php-messenger.com/samples/sample_icq.php - URL of this sample
