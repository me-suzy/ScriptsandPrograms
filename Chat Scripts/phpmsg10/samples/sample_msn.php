<HTML>
	<HEADER>
		<TITLE>PHP Messenger, MSN send message sample</TITLE>
	</HEADER>
	
	<BODY><CENTER><H1>Sample using <a href="http://www.php-messenger.com">PHP Messenger</a><br>for sending MSN messages.<br></H1>
...
<?php		
	// http://www.php-messenger.com/samples/sample_msn.php - URL of this sample

	if ($my_uin!="" && $my_pass!="" && $to_uin!="" && $text!="")
	{
		require ("php_messenger.php");  			// Include PHP MESSENGER
		$pm=new PM_MSN();              				// Create AIM object
