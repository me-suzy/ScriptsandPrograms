...
if (!$first_enter && !$failed_data) {
	if ($username == "") {
		...
		if (mysql_num_rows($result) != 0) {	/* login ok! */
			...
			$query = "INSERT INTO msg VALUES ('', '', '$username', '', DATE_ADD(NOW(), INTERVAL $diff_timezone HOUR))";
			do_the_query($chat_db, $query);
		}
		else {
			$failed_data = true;
...
echo "<LINK REL=\"stylesheet\" HREF=\"style.css.php\" TYPE=\"text/css\">\r\n";
echo "<META HTTP-EQUIV=\"Content-Type\" CONTENT=\"text/html; CHARSET=iso-8859-1\">\r\n";
echo "<TITLE>Register and login in the chat</TITLE>\r\n";
echo "</HEAD>\r\n\r\n";
...
echo "<DIV CLASS=\"center\"><TABLE BORDER=\"0\" BGCOLOR=\"$darkblue\" CELLSPACING=\"0\" CELLPADDING=\"10\" WIDTH=\"65%\">\r\n";
echo "<TR>\r\n";
echo "<TD COLSPAN=\"2\" VALIGN=\"top\">\r\n";

echo "<DIV CLASS=\"center\"><TABLE BORDER=\"0\" BGCOLOR=\"$lightblue\" WIDTH=\"95%\" CELLSPACING=\"0\" CELLPADDING=\"3\">\r\n";
echo "<TD WIDTH=\"50%\" VALIGN=\"top\" CLASS=\"center\">\r\n";
echo "<SPAN CLASS=\"bigwhite\">New user?</SPAN>\r\n";
echo "</TD>\r\n";
echo "<TD WIDTH=\"50%\" VALIGN=\"top\" CLASS=\"center\">\r\n";
echo "<SPAN CLASS=\"bigwhite\">Already a member?</SPAN>\r\n";
echo "</TD>\r\n";
echo "</TR>\r\n";
echo "</TABLE></DIV>\r\n";
...
if ($failed_data && isset($subscribe)) {
	if ($email == "") {
		echo "<SPAN CLASS=\"highlight\"><B>IT IS NECESSARY TO ENTER YOUR EMAIL (DON'T YOU WORRY, IT WILL BE KEPT SECRET!)</B></SPAN><BR>&nbsp;<BR>\r\n";
	}
	else if ($password == "") {
		echo "<SPAN CLASS=\"highlight\"><B>IT IS NECESSARY TO INSERT A PASSWORD</B></SPAN><BR>&nbsp;<BR>\r\n";
	}
	else /*if ($username == "")*/ {
		echo "<SPAN CLASS=\"highlight\"><B>SOMEBODY ELSE IS REGISTERED WITH YOUR NAME. PLEASE CHOOSE ANOTHER</B><BR>Thanks.</SPAN><BR>&nbsp;<BR>\r\n";
	}
}
else {
	echo "If you are a new user please compile this fields and then press the button to enter the chat!<BR>&nbsp;<BR>\r\n";
}
echo "</TD>\r\n";
echo "<TD WIDTH=\"50%\" VALIGN=\"top\">\r\n";
if ($failed_data && isset($enter)) {
	echo "<SPAN CLASS=\"highlight\"><B>WRONG LOGIN, PLEASE CHECK USERNAME AND PASSWORD</B></SPAN><BR>&nbsp;<BR>\r\n";
}
else {
	echo "If you already registered in the past please insert your nickname and your password<BR>&nbsp;<BR>\r\n";
}
echo "</TD>\r\n";
echo "</TR>\r\n";
...
echo "<SPAN CLASS=\"highlight\">Which nickname do you want to use?</SPAN><BR>\r\n";
echo "<INPUT TYPE=\"text\" NAME=\"username\" SIZE=\"15\" VALUE=\"$username\"><BR>&nbsp;<BR>\r\n";
echo "<SPAN CLASS=\"highlight\">Choose a <B>password</B>, please:</SPAN><BR>\r\n";
echo "<INPUT TYPE=\"password\" NAME=\"password\" SIZE=\"15\" VALUE=\"$password\"><BR>&nbsp;<BR>\r\n";
echo "<SPAN CLASS=\"highlight\">Please insert here your email(*)?</SPAN><BR>\r\n";
echo "<INPUT TYPE=\"text\" NAME=\"email\" SIZE=\"15\" VALUE=\"$email\"><BR>\r\n";
echo "(*) your email <B>won't be</B> seen by the other users<BR>&nbsp;<BR>\r\n";
...
echo "<TD WIDTH=\"50%\" VALIGN=\"top\">\r\n";
echo "<FORM METHOD=\"post\" ACTION=\"$PHP_SELF\">\r\n";
echo "<SPAN CLASS=\"highlight\">Which is your nickname?</SPAN><BR>\r\n";
echo "<INPUT TYPE=\"text\" NAME=\"username\" SIZE=\"15\" VALUE=\"$username\"><BR>&nbsp;<BR>\r\n";
echo "<SPAN CLASS=\"highlight\">Which is your <B>password</B>?</SPAN><BR>\r\n";
echo "<INPUT TYPE=\"password\" NAME=\"password\" SIZE=\"15\" VALUE=\"$password\">\r\n";
echo "<BR>&nbsp;<BR>\r\n";
echo "<INPUT TYPE=\"submit\" NAME=\"enter\" VALUE=\"Enter the chat!\">\r\n";
echo "</FORM>\r\n";
echo "</TD>\r\n";
echo "</TR>\r\n";
...
echo "<TR>\r\n";
echo "<TD COLSPAN=\"2\" VALIGN=\"top\">\r\n";
echo "Please send comments to <A HREF=\"mailto:$mail_address\">$mail_address</A>\r\n";
echo "</TD>\r\n";
echo "</TR>\r\n";
