	...
	class St_ConfigManager{
		...
		*/
		function St_ConfigManager(){
			...
			$this->pathConfig = $this->configParser->parseMainConfigToArray("config/path-config.xml");
		...
		*/
		function getDataDir(){
			return trim($this->pathConfig['data_dir']);
		}
		...
		*/
		function getSmileyConfigFile(){
			return trim($this->pathConfig['data_dir']).'/'.trim($this->smiletagConfig['smiley_config_file']);
		}
		...
		*/
		function getBadwordFile(){
			return trim($this->pathConfig['data_dir']).'/'.trim($this->smiletagConfig['badword_file']);
		}
		...
		*/
		function getSmileyPattern(){
			$smileyConfigFile = $this->getSmileyConfigFile();
		...
		*/
		function getBadwordPattern(){
			$badwordFile = $this->getBadwordFile();
