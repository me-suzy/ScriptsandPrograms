...
?><?PHP
	...
	function usr_action_window(){
		...
		opener.window.parent.frames['bottom_right'].document.getElementById('profilename').innerHTML = '$txt[90]';\n
		...
		opener.window.parent.frames['profile'].document.location='./index.php?act=frame&frame=profile&room=$_GET[room]&user=$_GET[user]';\n
		</script>\n
		";
