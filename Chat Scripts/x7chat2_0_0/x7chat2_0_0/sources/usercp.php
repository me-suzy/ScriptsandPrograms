	...
	function usercp_master(){
		...
		if(@$_GET['cp_page'] == "main"){
			...
			$body .= "{$x7p->profile['status']}</i><br><Br>
					$txt[147]:<Br>
					&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"./index.php?act=usercp&cp_page=status&new_status=$txt[149]\">$txt[149]</a><Br>
					&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"./index.php?act=usercp&cp_page=status&new_status=$txt[150]\">$txt[150]</a><Br>
					&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"./index.php?act=usercp&cp_page=status&new_status=$txt[151]\">$txt[151]</a><Br>
					&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"./index.php?act=usercp&cp_page=status&new_status=$txt[152]\">$txt[152]</a><Br>
					<Br>
			...
			while($row = $db->Do_Fetch_Row($query)){
				$body .= "&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"./index.php?act=usercp&cp_page=blocklist&remove=$row[0]\">[$row[0]]</a><Br>";
			}
			...
			foreach($type5s as $key=>$val){
				if(!eregi("<a href=",$val[1])){
					$body .= "&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"./index.php?act=usercp&cp_page=wfilter&remove=$val[0]\">$val[0] ($val[1])</a><Br>";
				}
			}
			...
			if(isset($_GET['read'])){
				...
				$body .= "<Br><Br><table width=\"98%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
						...
						<Tr>
							<td class=\"dark_row\"><br><hr><a href=\"./index.php?act=usercp&cp_page=msgcenter&delete=$mid\">[$txt[175]]</a></td>
						</tr>
					</table><Br><Br><div align=\"center\"><a href=\"index.php?act=usercp&cp_page=msgcenter\">[$txt[77]]</a></div>";
				...
				foreach($msgs as $id=>$val){
					...
					$body .= "<tr>
								...
								<td width=\"100\" class=\"dark_row\"><a href=\"./index.php?act=usercp&cp_page=msgcenter&read=$mid\">$subject</a></td>
								<td width=\"100\" class=\"dark_row\">$author</td>
								<td class=\"dark_row\"><a href=\"./index.php?act=usercp&cp_page=msgcenter&delete=$mid\">[$txt[175]]</a></td>
							</tr>";
				}
			...
			if(isset($_POST['email'])){
				...
				if($error == ""){
					...
					$body = "<div align=\"center\">".$error."<Br><Br><a href=\"./index.php?act=usercp&cp_page=profile\">$txt[77]</a></div>";
				}
				
			}else{
			
				$body = "<Br>
						<form action=\"index.php?act=usercp&cp_page=profile\" method=\"post\" name=\"profileform\">
			...
			if(isset($_GET['uploaded'])){
				...
				$body = "<br>$txt[193]<br><Br><div align=\"center\"><form action=\"index.php?act=usercp&cp_page=upload&uploaded=1\" method=\"post\" enctype=\"multipart/form-data\">
			...
			if(isset($_GET['settings_change'])){
				...
				// Output body
				$body = "<Br>
						<form action=\"index.php?act=usercp&cp_page=settings&settings_change=1\" method=\"post\">
						<table align=\"center\" border=\"0\" cellspacing=\"0\" cellpadding=\"2\">
							<tr>
							...
							<tr>
								<td width=\"90\">$txt[204]:</td>
								<td width=\"100\">
									<select name=\"language\" class=\"text_input\">
										$def[languages]
									</select>
								</td>
							</tr>
			...
			if($x7c->permissions['log_pms'] == 0){
				...
				if($x7c->settings['log_pms'] == 1)
					$body = "$txt[242].  <a href=\"index.php?act=usercp&cp_page=logs&subact=disable\">[$txt[245]]</a><Br><Br>";
				else
					$body = "$txt[243].  <a href=\"index.php?act=usercp&cp_page=logs&subact=enable\">[$txt[244]]</a><Br><Br>";
				...
				$_GET['selected_log'] = eregi_replace("\.","",$_GET['selected_log']);
					...
					$body .= "<div align=\"center\"><Br><a href=\"index.php?act=usercp&cp_page=logs\">[$txt[77]]</a></div><Br><Br>";
				}elseif($x7c->settings['log_pms'] == 1){
					$body .= "$txt[251]<br><Br>";
					
					$logs = $log->get_pm_loglist();
					foreach($logs as $key=>$user){
						$body .= "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"index.php?act=usercp&cp_page=logs&selected_log=$user\">$user</a> <a href=\"index.php?act=usercp&cp_page=logs&subact=&clear=$user\">[$txt[250]]</a><Br>";
					}
				}
		...
		function whatsmyclass($id){
			...
			if($x == $id)
				...
				return " class=\"ucp_cell\" onMouseOver=\"javascript: this.className='ucp_sell'\" onMouseOut=\"javascript: this.className='ucp_cell'\"  onClick=\"javascript: window.location='./index.php?act=usercp&cp_page=$id'\"";
		}
