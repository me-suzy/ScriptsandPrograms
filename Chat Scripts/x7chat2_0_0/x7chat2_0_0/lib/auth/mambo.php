...
?><?PHP
	...
	if(isset($_COOKIE['sessioncookie'])){
		$_COOKIE['sessioncookie'] = md5($_COOKIE['sessioncookie'].$_SERVER['REMOTE_ADDR']);
		$query = $mamdb->DoQuery("SELECT userid FROM {$mosConfig_dbprefix}session WHERE session_id='$_COOKIE[sessioncookie]'");
