        ...
        <tr>
          <td><table width="100%" border="1" cellpadding="0" cellspacing="3" bordercolor="#0000FF" >
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td><strong><u><font color="#000000"><? echo $showviews;?></font></u></strong></td>
              </tr>
            </table>
            <p align="justify">
              <?php 		if(@mysql_num_rows($get_banners) > 0){
			include("sortingbanner.php"); ?></font></strong></p>
              </p>
			<form name="viewbanner" id="viewbanner" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>" style="display:inline;">
              <table width="100%" border="1" align="center" cellpadding="5" cellspacing="0" bordercolor="#00CCFF">
                <tr bgcolor="#666666"> 
                  <td width="88%" bgcolor="#99CC99"><strong><font color="#000000">Banner 
                    List:</font></strong></td>
                </tr>
                ...
                <tr> 
                  <td><div align="left"><strong><font color="#000000"> 
                      <input name="viewme" type="radio" title="Select This Banner To View" value="<? echo $each_banner[0];?>" <? echo $issel;?>>
                      <?php
					   if($_POST['group'] == NULL){
						   echo $each_banner[1];
						  } else {
                ...
                <tr>
                  <td> <div align="center">
                      ...
                      <input type="submit" name="Submit" value="View Banner Stats"  title="View Banner Stats!" >
                  </div></td>
                </tr>
              </table>
</form>
