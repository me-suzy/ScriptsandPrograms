      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="5">
        <tr>
          <td><table width="100%" border="1" cellpadding="0" cellspacing="3" bordercolor="#0000FF" >
            ...
            <p></p>
            <form name="editbanner" id="editbanner" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>" style="display:inline;">
              <table width="100%" border="1" align="center" cellpadding="5" cellspacing="0" bordercolor="#00CCFF">
                ...
                <tr>
                  <td><div align="left"><strong><font color="#000000">
                      <input name="editme" type="radio" title="Select This Banner To View" value="<? echo $each_banner[0];?>" <? echo $issel;?>>
                      <?php
					   if($_POST['group'] == NULL){
						   echo $each_banner[1];
						  } else {
                ...
                <tr>
                  <td>
                    <div align="center">
                      ...
                      <input type="submit" name="Submit" value="Edit banner"  title="View Banner Stats!" >
                  </div></td>
                </tr>
              </table>
            </form>
