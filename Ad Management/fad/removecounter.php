      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="5">
        <tr>
          <td><table width="100%" border="1" cellpadding="0" cellspacing="3" bordercolor="#0000FF" >
            ...
            <form name="removecounter" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>" >
              <table width="100%" border="1" align="center" cellpadding="5" cellspacing="0" bordercolor="#00CCFF">
                ...
                <tr> 
                  <td><div align="left"><strong> 
                      <input name="removeme" type="radio" title="Select This Counter To View"  value="<?php echo $each_counter[0];?>" <?php echo $issel;?>>
                      <?php					   
						   echo $each_counter[1];
					  ?>
                      </strong></div></td>
                ...
                <tr> 
                  <td> <div align="center"> 
                      ...
                      <input name="submitid" type="hidden" value="11">
                      <input type="submit" name="Submit" value="Remove Counter"  title="Remove Counter Stats!" >
                  </div></td>
                </tr>
              </table>
            </form>
