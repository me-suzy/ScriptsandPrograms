...
if (isset($submit))
{
	...
	$final['appendtype'] = isset($final['appendtype']) ? addslashes($final['appendtype']) : '0';
	...
	// Set integers to 0 if empty
	if ($final['width'] === '')		$final['width'] = 0;
	if ($final['height'] === '')	$final['height'] = 0;
	if ($final['weight'] === '')	$final['weight'] = 0;
	...
	else
	{
		...
		$bannerid = phpAds_dbInsertID($phpAds_config['tbl_banners'].'_bannerid_seq');
	}
