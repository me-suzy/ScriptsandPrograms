...
if ($phpAds_config['compact_stats']) 
{
	$res = phpAds_dbQuery("
		SELECT
			...
			DATE_FORMAT(day, '$date_format[0]') as date_formatted
		FROM
...
else
{
	$res = phpAds_dbQuery("
		 SELECT
			DATE_FORMAT(t_stamp::date, 'YYYYMMDD') as date,
			DATE_FORMAT(t_stamp::date, '$date_format[0]') as date_formatted
		 FROM
...
if (phpAds_isUser(phpAds_Admin))
{
	...
	phpAds_PageHeader("2.1.1.1");
		...
		echo "<img src='images/icon-date.gif' align='absmiddle'>&nbsp;<b>".date(str_replace('%', '', $date_format[1]), mktime(0, 0, 0, substr($day, 4, 2), substr($day, 6, 2), substr($day, 0, 4)))."</b><br><br><br>";
...
if (phpAds_isUser(phpAds_Client))
{
	phpAds_PageHeader("1.1.1");
		echo "<img src='images/icon-date.gif' align='absmiddle'>&nbsp;<b>".date(str_replace('%', '', $date_format[1]), mktime(0, 0, 0, substr($day, 4, 2), substr($day, 6, 2), substr($day, 0, 4)))."</b><br><br>";
