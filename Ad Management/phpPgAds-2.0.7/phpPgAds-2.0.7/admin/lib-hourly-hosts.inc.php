...
if (!$phpAds_config['compact_stats']) 
{
	...
	while ($row = phpAds_dbFetchArray($result))
	{
		...
		echo strftime($time_format[1], $row['time']);
		...
		if ($flag = ($row["country"] == 'A1' || $row["country"] == 'A2') ? 'unknown' : strtolower($row["country"]))
			echo "<img src='images/flags/".$flag.".gif' width='19' height'11'>&nbsp;";
		echo $row["country"] != '' ? $phpAds_ISO3166[$row["country"]] : '-';
