...
if ($phpAds_config['compact_stats'])
{
	$query = "
		...
		WHERE
			".$phpAds_config['tbl_banners'].".bannerid = ".$phpAds_config['tbl_adstats'].".bannerid AND
		...
		WHERE
			clientid = '$campaignid'
			AND NOT EXISTS (SELECT * FROM ".$phpAds_config['tbl_adstats']." AS a WHERE b.bannerid = a.bannerid)
		";
...
else
{
	$query = "
		...
		WHERE
			".$phpAds_config['tbl_banners'].".bannerid = ".$phpAds_config['tbl_adviews'].".bannerid AND
			".$phpAds_config['tbl_banners'].".clientid = $campaignid
		GROUP BY
			".$phpAds_config['tbl_banners'].".bannerid,
			".$phpAds_config['tbl_banners'].".description,
		...
		WHERE
			clientid = '$campaignid'
			AND NOT EXISTS (SELECT * FROM ".$phpAds_config['tbl_adviews']." AS a WHERE b.bannerid = a.bannerid)
		";
	...
	$query = "
		...
		WHERE
			".$phpAds_config['tbl_banners'].".bannerid = ".$phpAds_config['tbl_adclicks'].".bannerid AND
			".$phpAds_config['tbl_banners'].".clientid = $campaignid
		GROUP BY
			".$phpAds_config['tbl_banners'].".bannerid,
			".$phpAds_config['tbl_banners'].".description,
		...
		WHERE
			clientid = '$campaignid'
			AND NOT EXISTS (SELECT * FROM ".$phpAds_config['tbl_adclicks']." AS a WHERE b.bannerid = a.bannerid)
		";
