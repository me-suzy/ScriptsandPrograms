...
$GLOBALS['strUseQuotes']					= "Gunakan tanda kutip";
...
// Append
$GLOBALS['strAppendType']					= "Jenis lampiran";
$GLOBALS['strAppendHTMLCode']					= "Kode HTML";
$GLOBALS['strAppendWhat']					= "Apa yang ingin dilampirkan?";
$GLOBALS['strAppendZone']					= "Lampirkan pada zona tertentu";
$GLOBALS['strAppendErrorZone']					= "Anda perlu pilih zona sebelum \\nbisa melanjut. Kalau tidak, tidak ada banner yang akan \\ndilampirkan.";
$GLOBALS['strAppendBanner']					= "Lampirkan satu atau lebih banner individual";
$GLOBALS['strAppendErrorBanner']				= "Anda perlu pilih satu atau lebih banner terlebih dahulu  \\nsebelum bisa melanjut. Kalau tidak, tidak ada banner yang akan \\ndilampirkan.";
$GLOBALS['strAppendKeyword']					= "Lampirkan banner dengan cara menggunakan kata kunci";
$GLOBALS['strAppendErrorKeyword']				= "Anda perlu pilih satu atau lebih kata kunci terlebih dahulu \\nsebelum bisa melanjut. . Kalau tidak, tidak ada banner yang akan \\ndilampirkan.";
...
$GLOBALS['strCollectedAll']					= "Seluruh statistik yang terkumpul";
$GLOBALS['strCollectedToday']					= "Statistik untuk hari ini saja";
$GLOBALS['strCollected7Days']					= "Statistik untuk 7 hari terakhir saja";
$GLOBALS['strCollectedMonth']					= "Statistik untuk bulan ini saja";
$GLOBALS['strCollectedYesterday']				= "Statistik untuk kemarin saja";
$GLOBALS['strCollectedRange']					= "Pilih jangka waktu";
