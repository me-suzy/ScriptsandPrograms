...
$GLOBALS['strAdvancedSettings']			= "Penyetelan Database Lanjut";
...
$GLOBALS['strDatabasePage']			= "Database ".$phpAds_dbmsname."";
$GLOBALS['strInstallWarning']			= "Pemeriksaan server dan integritas";
$GLOBALS['strCongratulations']			= "Selamat!";
$GLOBALS['strInstallFailed']			= "Instalasi gagal!";
$GLOBALS['strSpecifyAdmin']			= "Konfigurasi Account Administrator";
$GLOBALS['strSpecifyLocaton']			= "Menetapkan lokasi dari ".$phpAds_productname." pada server";
...
$GLOBALS['strCouldNotConnectToDB']		= "Gagal menghubungi database. Mohon periksa ulang penyetelan yang telah dilakukan. Selain itu pastikan bahwa sebuah database dengan nama yang telah ditentukan oleh Anda sudah berada pada server database. ".$phpAds_productname." tidak akan membuat database untuk Anda, Anda perlu membuatnya sendiri sebelum menjalankan Installer.";
...
$GLOBALS['strWarningPHPversion']		= $phpAds_productname." membutuhkan veri PHP 4.0.3 atau lebih tinggi untuk berfungsi dengan baik. Pada saat ini Anda mengunakan {php_version}.";
...
$GLOBALS['strWarningMagicQuotesSybase']		= "Variabel magic_quotes_sybase pada konfigurasi PHP harus dimatikan.";
...
$GLOBALS['strCacheLockedDetected']		= "Anda gunakan sistem Files delivery caching dan ".$phpAds_productname." telah deteksi bahwa direktori <b>cache</b> tidak bisa ditulis oleh server. Anda tidak bisa melanjut sampai hak terhadap direktori tersebut dirubah. Bacalah dokumentasi yang dilampirkan bila Anda kurang hapal dengan caranya.";
...
$GLOBALS['strRevCorrupt']			= "File <b>{filename}</b> rusak atau telah dirubah. Bila Anda tidak merubah file ini cobalah meng-upload salinan baru ke server. Bila Anda memang ubah file ini, silakan apaikan peringatan ini.";
$GLOBALS['strRevTooOld']			= "Umur dari File <b>{filename}</b> lebih tua daripada file yang diperlukan untuk versi ".$phpAds_productname." ini. Mohon upload salinan dari file ini yang lebih baru ke server.";
$GLOBALS['strRevMissing']			= "File <b>{filename}</b> tidak bisa diperiksa sehubungan ia tidak ditemukan. Mohon upload salinan dari file ini ke server.";
$GLOBALS['strRevCVS']				= "Anda telah mencoba untuk meng-instal sebuah salinan CVS dari ".$phpAds_productname.". Ini bukan pengeluaran yang resmi dan ada kemungkinan salinan ini kurang stabil atau tidak berfungsi samasekali. Apakah Anda yakin dan tetap ingin lanjut?";
...
$GLOBALS['strInstallMessageCheck']		= $phpAds_productname." sudah periksa integritas dari file-file yang di-upload oleh Anda dan telah check apakah server Anda sanggup untuk menjalankan ".$phpAds_productname.". Hal(-Hal) berikut membutuhkan perhatian Anda sebelum melanjut.";
$GLOBALS['strInstallMessageAdmin']		= "Sebelum melanjut Anda perlu membuat sebuah account Administrator. Account tersebut diperlukan untuk Login ke bagian Administrator untuk mengatur inventori Anda dan memeriksa seluruh statistik.";
$GLOBALS['strInstallMessageDatabase']		= $phpAds_productname." mengunakan database ".$phpAds_dbmsname." untuk menyimpan inventori dan seluruh statistik. Sebelum Anda lanjut mohon terapkan informasi tentang server yang digunakan dan nama pengguna dan kata sandi mana yang akan dipakai oleh ".$phpAds_productname." untuk menghubungi server. Bila Anda tidak tahu informasi apa yang diperlukan disini silahkan menghubungi Administrator dari server Anda.";
...
$GLOBALS['strPhpBug20144']			= "Versi PHP yang digunakan oleh Anda mengandung sebuah <a href='http://bugs.php.net/bug.php?id=20114' target='_blank'>bug</a> yang mengakibatkan ".$phpAds_productname." tidak bisa berfungsi dengan baik.
							Meng-upgrade ke PHP 4.3.0+ diperlukan sebelum Anda melakukan instalasi ".$phpAds_productname.".";
...
$GLOBALS['strGeotrackingLocationNoHTTP']	= "Lokasi yang disediahkan oleh Anda adalah bukan direktori lokal pada Harddrive dari server tetapi sebuah URL yang menujuh ke sebuah webserver. Lokasi sebenarnya harus mirip seperti ini: <i>{example}</i>. Lokasi sebenarya tergantung pada lokasi salinan database.";
...
$GLOBALS['strAdminFullName']			= "Nama lengkap Administrator";
$GLOBALS['strAdminEmail']			= "Alamat E-mail Administrator";
