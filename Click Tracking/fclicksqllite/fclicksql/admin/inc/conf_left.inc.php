 ...
 <TR>
  <TD>
   <TABLE bgcolor="#FFFFFF" cellpadding=2 cellspacing=1 border=0 width="100%" class=text>
    <TR><TD bgcolor="#a5bcc0"><strong>Configuration</strong></TD></TR>
    <TR><TD onmouseover="mMOver(this);" onmouseout="mMOut(this);" bgcolor="#eaeaea">
      <a class="link" href="admin.php?page=conf_gen">General</a>
    </TD></TR>
    <TR><TD onmouseover="mMOver(this);" onmouseout="mMOut(this);" bgcolor="#eaeaea">
      <a class="link" href="admin.php?page=conf_db">Database</a>
    </TD></TR>
   </TABLE>
  </TD>
 </TR>
...
<TABLE bgcolor="#000000" cellpadding=0 cellspacing=1 border=0 width="100%">
 <TR>
  <TD>
   <TABLE bgcolor="#FFFFFF" cellpadding=2 cellspacing=1 border=0 width="100%" class=text>
    <TR><TD bgcolor="#a5bcc0"><strong>Tools</strong></TD></TR>
    <TR><TD onmouseover="mMOver(this);" onmouseout="mMOut(this);" bgcolor="#eaeaea">
      <a class="link" href="admin.php?page=gen_show">Count Generator</a>
    </TD></TR>
   </TABLE>
  </TD>
 </TR>
