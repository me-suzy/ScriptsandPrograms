...
<frameset cols="150,*">
  <frame name="left" src="admin.php?page=conf_left" scrolling="no" noresize frameborder="0" target="main">
  <frame name="content" src="admin.php?page=conf_help" frameborder="0">
  <noframes>
  <body bgcolor="#FFFFFF">
