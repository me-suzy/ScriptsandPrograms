...
<tr>
<td align="center" class="dol"><form method="POST" action="index.php?<?php echo strip_tags (SID)?>"><p>&nbsp;<br><b>Please type in your admin password</b><br><br>
...
<p>&nbsp;</p>
<p><a href="index.php?<?php echo strip_tags (SID)?>">Back to the previous page</a></p>
<p>&nbsp;</p>
</td>
</tr> </table>
</div></center>
