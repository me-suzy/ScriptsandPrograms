...
if($getadmin3['status']==3)
{
   ...
   $getallphotos = "SELECT * from bl_photos order by mainpath ASC limit $start,20";
   $getallphotos2 = mysql_query($getallphotos) or die("Could not get photos");
   print "<table class='maintable'>";
   print "<tr class='headline'><td>Small Thumbnail</td><td>Filename</td><td>Delete</td></tr>";
   while($getallphotos3=mysql_fetch_array($getallphotos2))
   {
      
      print "<tr class='mainrow'><td><img src='../photos/thumbs/$getallphotos3[thumbpath]' height='100' width='100' border='0'>";
      print "<td>$getallphotos3[mainpath]</td><td><A href='delphoto.php?ID=$getallphotos3[photoid]'>Delete Photo</a></td></tr>";
   }
   print "</table><br><br>";
