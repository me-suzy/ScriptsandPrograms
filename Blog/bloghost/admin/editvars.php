...
if($getadmin3['status']>=1)
{
   ...
   if(isset($_POST['submit'])) //case for editing vars
   {
      ...
      else
      {
          ...
          $editvars="update bl_vars set title='$title',showprofile='$profile',showemail='$email',showresume='$resume',showpic='$pic',useguestbook='$guestbook',showcalendar='$calendar',usepoll='$poll',useleft='$useleft',useright='$useright',usephoto='$usephoto' where idvars='$getadmin3[adminid]'";
   ...
   {
      $getvars="SELECT * from bl_vars where idvars='$getadmin3[adminid]'"; //get current variable values
