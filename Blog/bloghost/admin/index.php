...
if($getadmin3['status']>=1)
{
   ...
   print "Welcome to your blog's admin panel. From here you can customize what options to show, post entries, edit comments, administrate your guestbook and poll, and edit and change your resume and calender. Your Blog page is at http://www.ferretfusion.com/members.php?membername=$blogadmin";
   print "</td></tr></table>";
}
else
{
