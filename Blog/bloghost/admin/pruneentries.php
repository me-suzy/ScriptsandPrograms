...
if(isset($_SESSION['blogadmin']))
{
  ...
  if(isset($_POST['submit']))
  {
     $month=$_POST['month'];
     $year=$_POST['year'];
     $getentries="SELECT * from bl_blog where month<'$month' and year<='$year' and author='$getadmin3[adminid]'";
     ...
     $getentriez="SELECT * from bl_blog where year<'$year' and author='$getadmin3[adminid]'";
     ...
     $deletecomment="DELETE from bl_blog where month<'$month'and year='$year' and author='$getadmin3[adminid]'";
     mysql_query($deletecomment) or die(mysql_error());
     $deletecommentz="DELETE from bl_blog where year<'$year' and author='$getadmin3[adminid]'";
