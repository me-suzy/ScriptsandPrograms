...
if (strlen($IPBANNED)>1)
...
else
   {
    ...
    if (!isset($_POST['submit']))
    {
     ...
     print "<form method='post' action='addentry.php?membername=$membername' name='form'>";
     print "<input type='hidden' name='idf' value='$getvars3[adminid]'>";
  ...
  else if (isset($_POST['submit']))
  {
   ...
   else
    {
     ...
     $putinguestbook="INSERT INTO bl_gbook(name, country, mail, homepage, comment, realtime, aim, icq, yim, msn, time,IP,identifier) VALUES('$name','$country','$email','$homepage','$comment','$day','$aim','$icq','$yim','$msn','$timegone','$r','$idf')";
     mysql_query($putinguestbook);
     print "Thanks for posting, you will now be redirected <META HTTP-EQUIV = 'Refresh' Content = '2; URL =index.php?membername=$membername'> ";
    }
