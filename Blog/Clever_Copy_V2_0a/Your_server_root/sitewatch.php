...
{
   echo "<table border='0' width=100%><tr><td><center><b>$site_watch_label</b><br></td></tr>";
   echo "<tr><td>";
   echo "<form method='post' action='sitewatch.php' name='form'>";
...
{
   echo "<center>";
   echo "<table border='0' width=95%><tr><td><center><b>$site_watch_label</b></center></td></tr>";
   echo "<tr><td>";
   $email=antihax($_POST['email']);
   if(strlen($email)<1)
   {
      echo "<p align = 'center'><br><b>$missing_post_data_error </b><META HTTP-EQUIV = 'Refresh' Content = '3; URL =sitewatch.php'>";
   ...
   if ($exists == "true")
   {
      ...
      @mysql_query("INSERT INTO CC_watch(address) VALUES('$email')" );
      $error_msg .= mysql_error();
   }
   if ($error_msg == "")
   {
         echo "<p align = 'center'><br><b>$site_watch_successful_label </b><META HTTP-EQUIV = 'Refresh' Content = '3; URL =index.php'>";
         echo "<p align = 'center'>$if_you_see_label <A href='index.php'> $click_here_label</a></p></table>";
   }else{
         echo "<p align = 'center'><br><b>$site_watch_error_label $error_msg</b><META HTTP-EQUIV = 'Refresh' Content = '5; URL =sitewatch.php'>";
         echo "<p align = 'center'>$if_you_see_label <A href='index.php'> $click_here_label</a></p></table>";
   }
}
echo "</center></td>";
