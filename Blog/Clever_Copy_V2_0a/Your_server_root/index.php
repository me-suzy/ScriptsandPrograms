...
{
  echo "<font color = '#FF0000'>Clever Copy has not yet been installed<br><br>";
  echo "To install Clever Copy go <a href='install/index.php'>here</font></a>";
  exit;
}
session_start();
...
echo "<font face = $getprefs3[block_heading_font_face] size = $getprefs3[block_heading_font_size] color= $getprefs3[block_heading_font_color]><$getprefs3[block_heading_font_decoration]>";
...
echo "</$getprefs3[block_heading_font_decoration]></center>";
if($getprefs3[showwelcome_message]==1){include "welcome.php";}
if($getprefs3[shownewsticker]==1){echo "<center>";include "ticker.php";}
include "showlast5class1block.php";
include "showlast5phorumblock.php";
include "showlastforumbb2block.php";
include "customtopblock.php";
include "news.php";
include "custombottomblock.php";
echo "<tr><td valign='top' width = '181'>";
echo "<img src=images/seperator.gif border='0' width='181' height='1'>";
echo "</td></tr></table>";
echo "</center></td>";
