...
if(isset($_SESSION['cuser']))
{
  echo "<tr><td align = 'left'><form method='post' action='readpm.php'>";
  echo "<input type='submit' value='$readpm_button_label' class = 'buttons'></form>";
  echo "<td align = 'right'><form method='post' action='sendpm.php'>";
  echo "<input type='submit' value='$sendpm_button_label' class = 'buttons'></form>";
  echo "</center>";
  echo "</td></tr></table>";
