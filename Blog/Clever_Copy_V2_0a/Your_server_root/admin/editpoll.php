...
include "../languages/default.php";
?>
<head><title>Clever Copy Admin - Poll Manager add on</title>
<?php
...
{
$banner_getinfo_label = "<b>The Poll Manager add on is not currently available on your site.</b><br>
<br>The poll manager is a purchased add on. With the poll manager installed you can run polls or surveys. Visitors will keep returning to
your site to vote in the polls or see the results.<br><br>
The poll manager is available for just $9.99
...
";
 ...
 echo "<font face=$getprefs3[block_heading_font_face] size=$getprefs3[block_heading_font_size] color=$getprefs3[block_heading_font_color]><$getprefs3[block_heading_font_decoration]>$edit_poll_label</font></b></td></tr>";
