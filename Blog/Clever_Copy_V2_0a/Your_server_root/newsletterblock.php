<?php
    ...
    if ($getprefs3[useblockwrapper]==1)
       ...
       echo "<font face=$getprefs3[block_heading_font_face] size=$getprefs3[block_heading_font_size] color=$getprefs3[block_heading_font_color]><$getprefs3[block_heading_font_decoration]>&nbsp;$getblocks3[newsletter_block_label]</font></b></center></td></tr>";
       ...
       echo "</td></tr></table><br>";
        ...
        {
        echo "<center><font face = $getprefs3[block_heading_font_face] size = $getprefs3[block_heading_font_size] color= $getprefs3[block_heading_font_color]><$getprefs3[block_heading_font_decoration]>$getblocks3[newsletter_block_label]</$getprefs3[block_heading_font_decoration]></center>"; 
