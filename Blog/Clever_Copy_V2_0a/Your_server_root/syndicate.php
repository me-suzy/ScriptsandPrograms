...
}else{ echo  "$welcome_back_user_label $visitor_name"; }
...
echo "<tr><td><b><center>$news_syndication_label</b><br>";
echo "<tr><td><br>";
echo "<p align = 'justify'>$news_syndication_def_label<br><br><br>";
echo "<tr><td>";
echo "<b>$syndicate_all_pages_label</b>";
echo "<tr><td>";
echo $syndicate_get_newsfeed_label;
echo "<tr><td>";
echo "<textarea rows='23' cols='98'>";
include "news/syndicateinfo.html";
echo "</textarea>";
echo "<tr><td><br>";
echo "<b>$syndicate_step_two_label</b>";
echo "<tr><td>";
echo $syndicate_php_label;
echo "<tr><td>";
echo "<textarea rows='3' cols='98'>";
echo "echo \"&lt;iframe src=http://www.yoursite.com/newsreader.php width=165 height=185 frameborder=0 scrolling=no>&lt;/iframe>\";";
echo "</textarea>";
echo "<tr><td>";
echo $syndicate_html_label;
echo "<tr><td>";
echo "<textarea rows='3' cols='98'>";
echo "&lt;iframe src=http://www.yoursite.com/newsreader.php width=165 height=185 frameborder=0 scrolling=no>&lt;/iframe>";
echo "</textarea>";
echo "<tr><td><br>";
echo "<b>$syndicate_step_three_label</b>";
echo "<tr><td>";
echo $syndicate_test_label;
echo "<tr><td align = 'justify'><align = 'justify'>$syndicate_cc_sites_label";
echo "</center></td>";
echo "</td></tr></table>";
