...
if(isset($_POST['submit']))
{
   ...
   else
   {
     ...
     print "Comment Posted. You will now be redirected <META HTTP-EQUIV = 'Refresh' Content = '2; URL =index.php'>";  
   } 
...
else if(isset($_GET['ID']))
{
   ...
   {
     print "<form action='postcomment.php?ID=$ID' method='post' name='form'>";
     print "Name:<br>";
