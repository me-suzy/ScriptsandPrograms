...
while (list(, $week) = each($weeks))
{
       ...
       while (list(, $d) = each($week)){ 
         ...
         if(($i >= $offset_count) && ($i < ($num_weeks * 7) - $outset)){ 
            ...
            $day_link = "<A href=\"javascript:popWin('editcalendar.php?ID=$datecount',350, 400)\">$d</a>";
           if($date == mktime(0,0,0,$month,$d,$year)){ 
               echo "<td><A href=\"javascript:popWin('editcalendar.php?ID=$datecount',350, 400)\"><font color='red'><b>$d</b></font></a></td>\n"; 
           } else { 
