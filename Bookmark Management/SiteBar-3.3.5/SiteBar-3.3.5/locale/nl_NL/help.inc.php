...
$help['102'] = <<<_P
De makkelijkste manier om links toe te voegen is met de bookmarklet. U kunt deze
aanmaken vanaf de homepage van de SiteBar installatie, welke standaard beschikbaar is
door op het SiteBar logo te klikken. Internet Explorers kunnen het context menu gebruiken
als deze de installer vanaf dezelfde pagina als het bookmarklet gebruiken.
_P;

$help['103'] = <<<_P
<@><p><strong>Zoek</strong> - Laat u zoeken in alle weergegeven links. Het is mogelijk
om op te geven waar gezocht moet worden met behulp van prefixes:
...
worden in "Gebruikers Instellingen". Wanneer er een map of link is gevonden
wordt deze gemarkeerd en er wordt een javascript venster getoond met enige details.
De gebruiker heeft de mogelijkheid om verder te zoeken of de zoekactie te stoppen.

<p><strong>Markeren</strong> - Hetzelfde als zoeken maar zonder het javascript venster.
...
$help['200'] = <<<_P
Commando's zijn gegroepeerd in diverse logische groepen. Selecteer één van de
groepen om de uitleg te zien voor het commando.
_P;

$help['210'] = <<<_P
<@><p><strong>Aanmelden</strong> - Meld de gebruiker aan, de gebruiker wordt altijd onthouden
met cookies. De gebruiker kan aangeven wanneer het cookie moet verlopen.

<p><strong>Afmelden</strong> - Meld de gebruiker af. Dit dient altijd op publieke computers
te worden gebruikt. Vergelijkbaar is om het aanmelden met een sessie te gebruiken en hierna
alle vensters te sluiten.

<p><strong>Word lid</strong> - Een bezoeker kan lid worden van het systeem. Op basis van het
e-mail adres kan de gebruiker zich wellicht bij bepaalde groepen aansluiten. In dit geval dient het
e-mail adres geverifieerd te worden. Dit gaat automatisch door een verificatie e-mail te sturen.
De beheerder van het systeem can het aanmelden van nieuwe gebruikers uitzetten.
_P;

$help['220'] = <<<_P
<p><strong>Installatie</strong> - Het eerste commando dat de beheerder ziet tijdens
de installatie van SiteBar, nadat een database is opgezet. Een beheerders account zal
worden gecreëerd en standaard sitebar parameters worden ingesteld. Indien de "Persoonlijke mode"
optie is gekozen, is slechts een subset van de functionaliteit beschikbaar.

<p><strong>SiteBar instellingen</strong> - Beheerders kunnen later de SiteBar parameters nog veranderen.
Beheerders zijn lid van de Beheerders Groep, net als de gebruiker die tijdens het "Installatie"
commando is gecreëerd. Zie "Word lid" voor een uitleg van de email functie.
Verdere email functionaliteit is gepland voor toekomstige releases.

<p><strong>Maak structuur aan</strong> - Afhankelijk van de SiteBar instellingen kunnen
beheerders en/of gebruikers met geverifiëerde email nieuwe structuren aanmaken.
...
om die vervolgens aan de gebruiker toe te wijzen die de groep modereert. Deze groep wordt apart aangemaakt
via "Maak groep aan". De moderator kan dan rechten in de nieuw aangemaakte structuur toekennen aan
de groepsleden, en kan tevens leden aan de groep toevoegen.
_P;
...
zichtbaar voor de eigenaar van de map structuur. Tevens worden de aan andere
groepsleden toegekende rechten verwijderd. Dit laatste dient als een extra niveau
van bescherming tegen het ongewilde verlies van bookmarks.
...
De validatie vereist de aanwezigheid van een outbound connectie.
...
getest worden. De reeds geteste links zijn voorzien van een icoon.
...
$help['301'] = <<<_P
SiteBar is getest met de volgende browsers
...
De volgende browsers hebben enkel leesrechten:
...
Een opmaak bestaat uit een reeks van plaatjes (het PNG formaat wordt
gebruikt vanwege GIF gerelateerde patentrechten die in Europa
verlopen in 2004), een Cascading Style Sheet genaamd "sitebar.css"
en een PHP bestand met plaatshouders, "hook.php".
In het plaatshouders bestand kunnen de headers en footers van
een sitebar installatie worden aangepast.

<p>

Sommige beheerders willen wellicht een opmaak creëren die past bij de
vormgeving van hun website. In dat geval is het aan te bevelen om alle
andere opmaken te verwijderen en de standaard opmaak vast te leggen in de
SiteBar instellingen. Indien U uw eigen opmaak aan de SiteBar distributie
toegevoegd zou willen zien, moet U contact opnemen met de ontwikkelaars
en de opmaak testen met de meest recente stabiele ontwikkelversie.
Als vuistregel wordt gesteld dat de SiteBar en SourceForge logo's
op de pagina aanwezig moeten zijn, maar het SiteBar logo mag in principe
willekeurig worden aangepast.
_P;
