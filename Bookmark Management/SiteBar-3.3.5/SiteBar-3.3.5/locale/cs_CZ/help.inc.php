...
$help['100'] = <<<_P
Funkce SiteBaru jsou dostupné z <strong>uživatelského menu</strong> a z
<strong>kontextového</strong> složek a odkazů. Uživatelské menu je vždy
zobrazeno ve spodní části SiteBaru. Kontextová menu složek a odkazů jsou
dostupná kliknutím pravého tlačítka myši na dané složce či odkazu. Uživatelé
Opera či Apple prohlížečů mohou použít kliknutí levého tlačítka spolu
se stisknutou klávesou Ctrl. V případě, že ani tato možnost není browserem
podporovaná lze v <strong>Nastavení</strong> zvolit zobrazování menu ikony.
Tato ikona je zobrazena vedle ikony složky či odkazu a kliknutím na ni se patřičné
kontextové menu vyvolá.
<p>
Jak kontextová menu tak uživatelské menu zobrazují rozdílné podmnožiny dotazů
pro různé uživatele v závislosti na jejich právech v systému. Některé položky
v kontextovém menu mohou být být znepřístupněny v závisloti na uživatelských
právech a právech k dané složce. Vybrané příkazy jsou prováděny v Příkazovém okně.
_P;

$help['101'] = <<<_P
Kliknutím na složku či odkaz myčí a následným tažením myši při stále stlačeném
tlačítku nad jinou složku je možné zkopírovat či přesunout tažený objekt.
Během tažení je cílová složka signalizována barevným zvýrazněním.
<p>
Tato funkce je implementována pro browsery rodiny Mozilla a pro Internet Explorer.
Uživatelé ostatních prohlážečů musí použít kontextové menu <strong>Kopírovat</strong> a
<strong>Vložit</strong>.
_P;

$help['103'] = <<<_P
<p><strong>Filtr</strong> - umožňuje vyfiltrovat právě zobrazených odkazy. Je možné
nastavit který parametr odkazu se má prohledávat pomocí následujících prefixů
<strong>url:</strong>, <strong>name:</strong> - název, <strong>desc:</strong> - popis,
<strong>all:</strong> - vše. Defaultní prefix je <strong>name:</strong>.

<p><strong>Hledat</strong> - stejná funkce jako filr, ovšem provedená na backendu a zobrazená v jiné formě.

<p><strong>Hledat na Internetu</strong> - hledá pomocí preferovaného vyhledávače.

<p><strong>Zabalit/rozbalit vše</strong> - zabalí všechny složky. Při druhém kliknutí
(a pokud jsou všechny složky zabalené) rozbalí všechny složky.

<p><strong>Znovu načíst se skrytými složkami</strong> - načte znovu odkazy ze SiteBar serveru včetně
složek skrytých příkazem "Skrýt složku".

<p><strong>Znovu načíst</strong> - načte znovu odkazy ze SiteBar serveru. Tato funkce
je implementována z toho důvodu, že obnova obsahu sidebaru je v některých browserech obtížná.
_P;

$help['200'] = <<<_P
Příkazy jsou sdruženy do několika logických skupin. Vybráním skupiny lze zobrazit nápovědu
