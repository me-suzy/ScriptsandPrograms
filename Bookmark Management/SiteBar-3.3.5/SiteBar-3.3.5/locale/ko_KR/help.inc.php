...
$help['102'] = <<<_P
링크를 추가하는 가장 편리한 방법은 북마크 추가 버튼(bookmarklet)입니다. SiteBar 로고를 클릭하면 나오는 SiteBar 설치 페이지에서 북마크 추가 버튼을 만들 수 있습니다. 북마크 추가 버튼이 설명된 페이지에는 IE에서 팝업 메뉴를 사용할 수 있게 하는 설치 방법도 설명되어 있습니다.
_P;

$help['103'] = <<<_P
<@><p><strong>검색</strong> - 화면에 보여졌었던 모든 링크에서 검색을 할 수 있습니다. 어떤 항목에 대해 검색할 것인지는 <strong>url:</strong>, <strong>이름:</strong>, <strong>부가설명:</strong>, <strong>모두:</strong> 접두사를 사용하여 지정할 수 있습니다. 기본 접수사는 <strong>이름:</strong>이지만 "사용자 설정"에서 변경할 수 있습니다. 검색 후 해당하는 링크나 폴더를 찾으면 그 링크나 폴더는 밝게 표시되며 그에 대한 몇가지 사항과 함께 자바스크립트 확인 윈도우가 나타날 것입니다. 사용자는 검색을 계속하거나 그만둘 수 있습니다.

<p><strong>밝게 표시</strong> - 검색과 동일하지만 자바스크립트 창이 나타나지 않습니다.
...
<p><strong>가입</strong> - 방문자가 시스템에 가입할 수 있도록 합니다. 메일 주소에 의해서 사용자가 어떤 그룹에 가입할 수 있는지 판별 할 수 있습니다. 이 경우에는 그 메일주소를 확인해야 합니다. 이러한 작업은 사용자에게 시스템이 자동으로 확인 메일을 보내서 처리합니다. 시스템의 관리자는 새로운 사용자의 가입을 그만하게 할 수 있습니다.
_P;
