...
$help[103] = <<<_H
<p><strong>Filter</strong> - Filters out links displayed on the front-end.
It is possible to specify what should be filtered using prefixes
<strong>url:</strong>, <strong>name:</strong>, <strong>desc:</strong>,
<strong>all:</strong>. Default prefix is <strong>name:</strong> and can be changed
in "User Settings".
...
and upon verification he becomes automatically group member. When "Allow Self Add"
is checked, the email does not need to be verified for auto join.
...
<p><strong>Show All Links</strong> - Shows links of all subfolders at once.

<p><strong>Show Link News</strong> - Show news about this folder and included
subfolders.
...
<p><strong>Validate Links</strong> - Validates all links in the folder and
...
folder when parent node is already published.

It is possible  to  switch  freely between personal and the default "enterprise"
mode, however, it is  not  possible in personal mode to remove rights granted
in enterprise mode to any other but Everyone group.
_H;
