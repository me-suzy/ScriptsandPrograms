...
* <a href="http://en.wikipedia.org/wiki/Bookmarklet">Bookmarklet</a> to zakładka, która zawiera kod JavaScript. Możesz kliknąć na niej prawym przyciskiem i dodać do paska zakładek. Późniejsze kliknięcie na tej zakładce uruchomi kod JavaScript.</i>
_P;
...
Ściągnij rozszerzenie Synchronizator Zakładek. Zrestartuj Firefoxa, otwórz menedżera rozszerzeń i w opcjach w ustawieniach zdalnych plików ustaw protokół <strong>HTTP</strong>, hosta <strong>%s</strong> i ścieżkę <strong>%s</strong>. Obecnie działa tylko synchronizacja SiteBar->Firefox.
_P;
...
Ściągnij i zainstaluj <a href="http://sourceforge.net/projects/mozlinker/">rozszerzenie</a> (uwaga, nie jest możliwa deinstalacja). Nowe menu "MozLinker" pojawi się w menu przeglądarki. Użyj podmenu "Config..." i dodaj albo nowe menu albo nowy pasek narzędzi. Jako źródłowy URL użyj URL z linku "MozLinker Extension" po lewej stronie.
_P;
...
$para['integrator::copyright2'] = <<<_P
Copyright � 2003-2005 <a href='http://brablc.com/'>Ondřej Brablc</a> oraz <a href='http://sitebar.org/team.php'>Ekipa SiteBar</a>.
Pomoc <a href='http://sourceforge.net/forum/forum.php?forum_id=261003'>forum</a>.
_P;
...
<strong>P</strong>-usuwanie nieodwracalne,
<strong>G</strong>-nadawanie praw
_P;
...
Włącz SiteBar w trybie instalacji dla jednego użytkownika.
_P;
...
Wczytuje jedynie zawartość otwartego katalogu.
_P;
...
Pokazuje linki opublikowane przez innych użytkowników.
_P;
...
Opublikuj katalog aby wszyscy mogli go widzieć.
_P;
