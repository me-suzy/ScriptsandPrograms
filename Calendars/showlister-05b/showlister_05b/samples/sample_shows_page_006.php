...
<?php
    ...
    while($row = mysql_fetch_array($result)) {
        ...
        // echo the shows
        echo("\t<tr>\n\t\t<td bgcolor='$bgcolor'>$the_month" . "/" . "$the_day" . "/" . "$the_year" . "</td>\n");
        echo("\t\t<td bgcolor='$bgcolor'>" . "$the_venue" . "</td>\n");
        echo("\t\t<td bgcolor='$bgcolor'>" . "$the_location" . "</td>\n");
        echo("\t\t<td bgcolor='$bgcolor'>" . "$the_details" . "</td>\n");
    }
    echo("\t</tr></table>\n</div>\n");
?>
    <div class='box'>
    ...
    ignores all artist information.  This page is suitable for sites that contain 
    show informatin about only one artist.  

    <br />&nbsp;<br />

    Additionally, this page uses varibles to alternate row colors (via the 
    bgcolor attribute of the &lt;td&gt; tags).
    </div>
  </body>
</html>