...
function crclcalform_onsubmit() {

	crclcalform.clcruname.value = trim(crclcalform.clcruname.value);
	crclcalform.clcrfname.value = trim(crclcalform.clcrfname.value);
	crclcalform.clcrlname.value = trim(crclcalform.clcrlname.value);
	crclcalform.clcremail.value = trim(crclcalform.clcremail.value);
	crclcalform.clcrpw.value = trim(crclcalform.clcrpw.value);
	crclcalform.clcrcaltit.value = trim(crclcalform.clcrcaltit.value);
	crclcalform.clcrcalname.value = trim(crclcalform.clcrcalname.value);
	crclcalform.clcradminname.value = trim(crclcalform.clcradminname.value);
	crclcalform.clcradminpass.value = trim(crclcalform.clcradminpass.value);
...
<form method="post" name="crclcalform" id="crclcalform" action="crclcal.php" LANGUAGE=javascript onsubmit="return crclcalform_onsubmit()">
<table border="1" cellpadding="0" cellspacing="0" style="BORDER-COLLAPSE: collapse" bordercolor="#111111" width="100%">
  ...
  <tr>
    ...
    <INPUT id="crclcalsubmit" type="submit" value="Submit" name="crclcalsubmit" >&nbsp;&nbsp;<INPUT id="reset1" type="reset" value="Reset" name="reset1"></td>
  </tr>
</table></form>
</body>
