...
if($row["keysum"] > 0) {
    ...
    $wptitle = "Event Reminder Subscription Cancelation";
...
?>
    ...
    <?php
        ...
        $sqlstr = "delete from ".$GLOBALS["tabpre"]."_cal_event_rems where confirmkey = '$xrkey'";
        ...
        print "<br><h3>Your Event Reminder Subscription has been canceled.<br><br>
        ...
        $logentry["evid"] = "0";
        $logentry["adate"] = time();
        $logentry["laction"] = "Event Reminder Subscription cancelation.";
        $logentry["lbefore"] = " ";
        $logentry["lafter"] = " ";
        $logentry["remarks"] = " ";
        histlog($logentry);
...
?>
    <html>
    <head>
    <title>Event Reminder Subscription cancelation problem</title>
    </head>

    <body <?php print $GLOBALS["sysbodystyle"]; ?>>
    <br>
    <form name="manreg" method="post" action="canevsub.php">
