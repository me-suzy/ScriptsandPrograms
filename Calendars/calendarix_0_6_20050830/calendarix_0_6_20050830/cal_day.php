...
if ((($publicview==1)&&($uname!=""))||($publicview==0)) {
  if ($addeventok==1){
    echo " &nbsp; <a href='#$week[$weekday]' onclick=\"Javascript:window.open('cal_addevent.php?op=eventform&add_day=$day&add_month=$month&add_year=$year&catview=$catview','popupwin','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=no,width=".$addeventwin_w.",height=".$addeventwin_h."');\"><img src='images/plus.gif' border=0 valign=middle alt='".translate("Add Event")."' width=11 height=11/></a>" ;
  }
}
