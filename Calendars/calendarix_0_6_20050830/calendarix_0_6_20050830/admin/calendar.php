...
echo "\n\n<table align=center class=monthview>";
    echo "<tr>";
	    ...
	    echo " &nbsp; <a href='#' onclick=\"Javascript:window.open('smallcal.php?op=smallcal&date=$pdate','popupmonth','toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,width=250,height=220');\">" ;
        ...
        echo " &nbsp; <a href='#' onclick=\"Javascript:window.open('yearcal.php?op=yearcal&ycyear=$askedyear','popupyear','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=no,width=600,height=600');\" class=calfontasked>" ;
	  ...
	  if ($ny <= $calendyear) {
	      ...
	      echo " &nbsp; <a href='#' onclick=\"Javascript:window.open('smallcal.php?op=smallcal&date=$ndate','popupmonth','toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,width=250,height=220');\">" ;
		echo "<img src='../images/smallcal.gif' border=0 alt='".translate("Popup Month")."' valign=middle width=16 height=16/></a> &nbsp; " ;
