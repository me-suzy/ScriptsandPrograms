...
global $EVENTS_TB,$CAT_TB,$language,$addeventok,$mth,$add_day,$add_month,$add_year,$calstartyear,$caladvanceyear,$week,$notimeentry,$time12hour,$catview;
...
echo "<form action=cal_addevent.php?op=addevent" ;
...
$result = mysql_query($query);
    while ($row = mysql_fetch_object($result)){
	  ...
	  else if ($row->cat_id==$catview) echo " selected " ;
...
function addevent($title,$description,$email,$url,$cat,$repeat,$bday,$bmonth,$byear,$rday,$rtimes,
$starttimehr,$starttimemin,$endtimehr,$endtimemin,$startperiod,$endperiod){
global $EVENTS_TB,$CAT_TB,$caleventapprove,$userlogin,$timezone,$mailevent,
$emailrcpt,$mth,$week,$notimeentry,$calstartyear,$caladvanceyear,$copyevent,$time12hour,$id;
