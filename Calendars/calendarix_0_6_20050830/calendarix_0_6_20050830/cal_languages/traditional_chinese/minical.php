...
<script language="JavaScript" src="<?php echo $urlpathtocal.'overlib.js'?>"><!-- overLIB (c) Erik Bosrup --></script> 
...
#
#  Copyright © 2004-2005 Vincent Hor
##########################################################################
...
echo "<a class=normalfont href='#' onmouseover=\"return overlib('Calendarix version ".$version."\\nCopyright © 2002-2005 Vincent Hor',FGCOLOR,'#FFFFFF',TEXTSIZE,'1',WIDTH,'225',VAUTO,HAUTO,CAPTION,'".translate("About Calendarix")."');\" onmouseout=\"return nd();\">";
