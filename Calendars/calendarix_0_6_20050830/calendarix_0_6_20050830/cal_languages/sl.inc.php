...
function translate($msgin){
	...
	case "Approval needed for posting of events.": $new = "Potrebno je odobrenje za poiljanje dogodka."; break;  
	...
	case "Delete category": $new = "Brii kategorijo"; break;
	case "Delete event": $new = "Brii dogodek"; break;
	case "Delete user": $new = "Brii uporabnika"; break;
	case "Deleting category": $new = "Brii kategorijo"; break;
	case "Deleting event": $new = "Brii dogodek"; break ;
	...
	case "No categories yet": $new = "ni e kategorij"; break;
	...
	case "Previous": $new = "Prejnji"; break;			
	case "Previous day": $new = "Prejnji dan"; break;
	case "Previous week": $new = "Prejnji teden"; break;

	case "Read more": $new = "Preberi v novem oknu"; break;
	case "reallydelcat": $new = "Ali res elite odstraniti kategorijo? Vsi dogodki v kategoriji bodo trajno izbrisani!"; break;
	...
	case "thankyoupost": $new = "Hvala za vpis dogodka, je e poslan."; break;
	...
	case "Total number of events for the month": $new = "Skupno tevilo dogodkov za mesec"; break ;
	case "Total number of events for user": $new = "Skupno tevilo dogodkov za uporabnika"; break ;		
	case "Total unapproved events for the month": $new = "Skupno tevilo neodobrenih dogodkov" ; break;
	...
	case "userdelok": $new = "Ali res elite izbrisati tega uporabnika ?"; break;
	case "username": $new = "uporabniko ime"; break;
	case "Username entered already exists. Please use another username.": $new = "Vpisan uporabnik e obstaja. Prosim uporabite drugo uporabniko ime."; break;
	...
	case "week number": $new = "tevilka tedna"; break;
	case "Week starts": $new = "Teden zaène"; break;
	case "wronglogin": $new = "Nepravilno uporabniko ime ali geslo"; break;

	case "Year": $new = "Leto"; break;
	case "Yes, delete event !": $new = "Da, brii dogodek !"; break;
	case "Yes, delete it!": $new = "Da, brii!"; break;
