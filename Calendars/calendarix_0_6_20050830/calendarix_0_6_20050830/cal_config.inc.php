...
$calstartyear = 2005 ;  // year for which calendar is valid
$caladvanceyear = 1 ;   // number of years more from current year for which calendar is valid, from 0 or more 
...
$emailrcpt = 'webmaster@calendarix.com' ;		// receipient's email address for events posted if $mailevent is active 
...
$calendarname = 'C A L E N D A R I X &nbsp; &nbsp; D E M O &nbsp;' ; // Calendar name
$leftfooter = '<a href="http://www.calendarix.com/">www.calendarix.com</a>' ;
$contact = 'webmaster@calendarix.com' ;
