...
while ($day_offset<date("w")) { 
/*	if (date("Y", mktime(0,0,0,$month,$day+1,$year)) <= ($y+$caladvanceyear)) */$day++ ; 
//	else break ;
	$day_offset = date("w", mktime(0,0,0,$month,$day,$year));
	$dayoff-- ;
}
