<?php
	...
	if ($_POST[btnSave]=='Modify')
	{
		...
		$update_task_query = "update calendar_tasks set description='$_POST[txtDescription]', startdatetime='$_POST[txtDate] $_POST[txtStartTime]:00', enddatetime='$_POST[txtDate] $_POST[txtEndTime]:00', priority='$_POST[selPriority]' where taskid=$_POST[modify_taskid]";
	...
	elseif ($_POST[btnSave]=='Add')
	{
		...
		$insert_task_query = "insert into calendar_tasks values ('','$_SESSION[userid]','$_POST[txtDescription]','$_POST[txtDate] $_POST[txtStartTime]:00','$_POST[txtDate] $_POST[txtEndTime]:00','$_POST[selPriority]','0')";
	...
	if ($_GET[taskid])
	{
		...
		$select_task_query = "select DATE_FORMAT(startdatetime,'%Y-%m-%d') as Start_Date, description, TIME_FORMAT(startdatetime,'%H:%i') as Start_Time , TIME_FORMAT(enddatetime,'%H:%i') as End_Time, priority from calendar_tasks where taskid like '$_GET[taskid]'";
									...
									<table border="0" width="100%">
										<tr>
											...
											<td align="left" colspan=3>
												<!-- hidden control to store currnetly selected date -->
										...
										<tr>
											...
											<td align="left">
												<input type="textbox" name="txtStartTime" value='<?php print "$task_row[Start_Time]";?>'>
												<br>
												(Format:&nbsp;&nbsp;hh<b>:</b>mm)
											</td>
											<td align="right"><b>End Time:</b>&nbsp;&nbsp;&nbsp;</td>
											<td align="left">
												<input type="textbox" name="txtEndTime" value='<?php print "$task_row[End_Time]";?>'>
												<br>
												(Format:&nbsp;&nbsp;hh<b>:</b>mm)
											</td>
										</tr>
