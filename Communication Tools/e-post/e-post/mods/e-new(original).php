...
if (isset($_POST['newsent']))
{
	...
	elseif ($_POST['recip']==''.$_SESSION['groupname'].'')
	{
...
{
$grabusers = "SELECT username FROM e_users WHERE groupname='$_SESSION[groupname]' AND username!='$_SESSION[valid_user]'";
...
//If you wish to remove the mail all group option then comment out the line below. This is done by inserting // at the start of the line.
echo '<option value="'.$_SESSION['groupname'].'">Mail all in group</option>';
