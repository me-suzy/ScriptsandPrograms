...
echo '<input type=image src="images/send.gif" value="send" style="font-size:10px";>';
echo '</form>';
...
{ 
  ...
  //extract email address and password 
   $query = "select email,passwd from e_users where email='$mailpass' AND username='$mailuser'"; 
